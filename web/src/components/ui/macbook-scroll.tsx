...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[120vh] md:min-h-[150vh] shrink-0 scale-[0.6] transform flex-col items-center justify-start py-10 [perspective:800px] sm:scale-50 md:scale-100 md:py-80"
    >
      <motion.div
        style={{
      ...
      <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-gray-200 dark:bg-[#272729]">
        {/* Above keyboard bar (The hinge area base) */}
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      {/* Silver Hinge Component (Stationary relative to display) */}
      <div
        style={{
      ...
      {/* The Actual Display (Rotating Part) */}
      <motion.div
        style={{
          scaleX: scaleX,
          scaleY: scaleY,
